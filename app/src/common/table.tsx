...
interface Heading {
  ...
  className?: string;
  sortable?: boolean;
  /** Set to false to show the full value without the 8-char truncate/tooltip behavior */
  truncate?: boolean;
}
...
interface CommonTableProps {
  ...
  /** Override the default View/Edit/Delete/Copy icon actions with custom buttons per row */
  renderActions?: (row: any) => React.ReactNode;
  /** Sorting (optional) — pass these to enable clickable sortable headers */
  sortKey?: string;
                  ...
                  <span className="inline-flex items-center gap-1">
                    ...
                    {heading.sortable && (
                      <ArrowUpDown
                        size={12}
                        className={
                          sortKey === heading.key ? "text-white" : "text-white/50"
                        }
                      />
                    )}
                  </span>
