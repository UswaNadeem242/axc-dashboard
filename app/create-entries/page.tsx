          ...
          {activeTab === "awb-details" && (
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full pb-2">
              ...
              <div className="flex justify-end gap-3 ">
                {/* bg-white p-4 rounded-2xl border border-axc-border shadow-sm */}
                ...
                <button type="submit" disabled={loading} className="px-5 py-4 bg-axc-navy hover:bg-axc-navy text-white rounded-lg text-xs font-bold transition shadow-sm">
