...
function StatBox({ label, value }: { label: string; value: number | string }) {
  return (
    <div className="bg-axc-navy text-white text-center py-1.5 flex-1">
      <div className="text-regular-small uppercase tracking-wide">{label}</div>
            ...
            action={
              <div className="flex justify-end gap-2">
                ...
                <button
                  type="button"
                  onClick={onSaveBag}
                  className="px-4 py-2 bg-axc-red text-white rounded text-regular-small font-bold uppercase cursor-pointer"
                >
                  Save &amp; Lock
                </button>
              </div>
